...
| 数据类型 | 存储路径 |
|---------|---------|
| 作品 | `data/{sec_uid}/videos.csv` |
| 评论 | `data/{sec_uid}/{年月}/{aweme_id}/comments.csv` |
| 回复 | `data/{sec_uid}/{年月}/{aweme_id}/replies.csv` |
| 视频 | `upload/{sec_uid}/videos/` |
| 图片 | `upload/{sec_uid}/images/` |
| 头像 | `upload/{sec_uid}/avatars/` |
| 表情 | `upload/{sec_uid}/stickers/` |
